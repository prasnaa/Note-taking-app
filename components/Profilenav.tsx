...
const Profilenav = () => {
  return (
    <div className="flex items-center justify-between mt-4 mx-6 mb-8 sm:mb-10">
      <button className="flex items-center gap-2 text-gray-700 hover:text-blue-600 transition-all duration-200 group">
        <CircleArrowLeft size={20} className="text-gray-900 group-hover:-text-blue transition-transform " />
