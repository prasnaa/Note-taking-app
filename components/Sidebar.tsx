...
const Sidebar = () => {
  ...
  return (
   <div className=" hidden lg:flex min-h-svh w-64 bg-gray-100 border-r border-gray-300 px-4 pt-4  flex-col justify-between ">
      ...
      <div>
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className={clsx("p-3 bg-blue-500 rounded-lg flex gap-1.5 shodow-sm hover:bg-blue-400 cursor-pointer", pathname === '/template' ? "border-2 bg-blue-500 text-white" : "bg-white")}>
            ...
            <Link href={'/calendar'}>
            <div className={clsx ("p-3 bg-blue-500 rounded-lg flex gap-1.5 shodow-sm hover:bg-blue-400 cursor-pointer", pathname === '/calendar' ? " border-2 bg-blue-500 text-white" : "bg-white")}>
